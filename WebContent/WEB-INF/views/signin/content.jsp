						...
						<div class="col-lg-8 col-md-8">
							...
							<form action="#">
								<div class="row">
									...
									<div class="mt-6">
										<button class="btn btn-lg" style="line-height: 3;" >SIGN IN</button>
									</div>
									<div>
										<img src=<%=application.getContextPath()%>/resources/images/bono01.jpg>
									</div>
								</div>
								<a class="ex" href="#" style="color: black">이메일 찾기></a> <a
									class="ex" href="#" style="color: black">비밀번호 찾기></a> <a
									class="ex" href="<%=application.getContextPath()%>/signup/content" style="color: black">회원가입</a>
							</form>
						</div>
					</div>
				</div>
