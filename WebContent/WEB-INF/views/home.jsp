												...
												<li>
													<div class="header-right-btn ml-40">
														<a href="#" class="btn"><img
															src="assets/img/icon/smartphone.svg" alt="">(10)
															892-293 2678</a>
													</div>
												</li>
											</ul>
							...
							<div class="col-xl-8 col-lg-9 col-md-12">
								<div class="hero__caption text-center">
									<h1 data-animation="bounceIn" data-delay="0.2s">
										Drone Photography<br> & Videography
									</h1>
									<p data-animation="fadeInUp" data-delay="0.4s">Duis aute
										irure dolor inasfa reprehenderit in voluptate velit esse
										cillum reeut cupidatatfug.</p>
									<a href="#" class="hero-btn" data-animation="fadeInUp"
					...
					<div class="col-xl-6 col-lg-6 col-md-10">
						<div class="about-caption mb-50">
							...
							<div class="section-tittle mb-35">
								<h2>
									Hassle-Free Drone<br> Photography
								</h2>
							</div>
							<p class="about-cap-top">Inasfa reprehenderit in voluptate
					...
					<div class="services-active">
						<div class="col-lg-4">
							<div class="single-cat">
								...
								<div class="cat-cap">
									<h5>
										<a href="services.html">Residential Real Estate
											Photography</a>
									</h5>
									<p>Aute irure dolor inasfa reprehenderit in voluptate velit
								...
								<div class="single-footer-caption mb-30">
									...
									<div class="footer-tittle">
										<div class="footer-pera">
											<p>Duis aute irure dolor inasfa reprehenderit in
												voluptate velit esse cillum reeut cupidatatfug.</p>
										</div>
										<ul class="mb-40">
