	...
	<main>
		...
		<!-- End Sample Area 여기까지 회원가입 제목 사용-->  
								...
								<div class="whole-wrap">
									<div class="container box_1170">
										<div class="section-top-border" style="padding-top: 0; padding-bottom: 20px; text-align: center;">
											<ul>
												<li>
												회원 아이디 ( )로 로그인 하시거나 아이디 찾기를 진행해 주세요.
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="button-group-area mt-40" style="font-size: 20px; padding-bottom: 70px;">
										<a href="<%=application.getContextPath()%>/views/signin/content.jsp;" class="genric-btn info radius" style="width: 100%; padding-left: 30px;">로그인</a>
									</div>
								</div>
								<div class="col-md-3">
								</div>
